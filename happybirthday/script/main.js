...
window.addEventListener('load', () => {
    ...
    Swal.fire({
        ...
        preConfirm: () => {
            ...
            const pass = document.getElementById('swal-input2').value.trim();
            ...
            if (id !== 'EGO' || pass !== 'KOKU') {
                Swal.showValidationMessage('Incorrect ID or Password 😢');
                return false;
            }
        ...
        if (loginResult.isConfirmed) {
            const name = loginResult.value.id;
